# CS3
CS3: Case Study, Movie Review Analysis

# Step 1: Read the HOOK Document
Within HOOK, you can read about the motivation, relevance, and reasoning behind this project
# Step 2: Read the Rubric
The rubric contains a more detailed breakdown of the project steps, along with specific instructions for reproducing the analysis. You should continue to reference it throughout the reproduction process.
...
There are several datasets we produced throughout the project. Download reviews_with_severity.csv from the DATA folder. A data appendix is also included to inform about the dataset.
